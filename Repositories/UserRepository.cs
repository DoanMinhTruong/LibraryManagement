...
namespace LibraryManagement.Repositories
{
    public class UserRepository : IUserRepository
    {
        ...
        public UserRepository(LibraryManagementContext context, IConfiguration config)
        {
            _context = context;
            _config = config;
        }
        ...
        public async Task<User?> Create(RegisterViewModel registerViewModel)
        {
            ...
            IEnumerable<User> result = await _context.Users.FromSqlRaw(sql,
                        ...
                        new SqlParameter("@gender", registerViewModel.Gender ?? 0),
                        new SqlParameter("@role", 2)).ToListAsync();
